  ...
  var MOVE_NODE_AT_ORIG_INDEX = keyOf_1({moveFrom: null});
  var INSERT_MARKUP = keyOf_1({insertMarkup: null});
  var REMOVE_AT = keyOf_1({removeAt: null});
  ...
  var _placeNodesAtDestination =
    function(parent, childOperations, nodesByOriginalIndex) {
      ...
      for (var k = 0; k < childOperations.length; k++) {
        ...
        } else if (REMOVE_AT in childOperation) ; else if (INSERT_MARKUP in childOperation) {
          finalIndex = childOperation.finalIndex;
  ...
  var PropagationPhases$1 = keyMirror_1({bubbled: null, captured: null});
  ...
  function isEndish(topLevelType) {
    return topLevelType === topLevelTypes$3.topMouseUp ||
           topLevelType === topLevelTypes$3.topTouchEnd ||
           topLevelType === topLevelTypes$3.topTouchCancel;
  }

  function isMoveish(topLevelType) {
    return topLevelType === topLevelTypes$3.topMouseMove ||
           topLevelType === topLevelTypes$3.topTouchMove;
  }
  function isStartish(topLevelType) {
    return topLevelType === topLevelTypes$3.topMouseDown ||
           topLevelType === topLevelTypes$3.topTouchStart;
  }
  ...
  var injection$2 = {
    ...
    validate: function() {
      var invalid = !injection$2.InstanceHandle||
        !injection$2.InstanceHandle.traverseTwoPhase ||
        !injection$2.InstanceHandle.traverseEnterLeave;
      if (invalid) {
  ...
  function accumulateDirectionalDispatches(domID, upwards, abstractEvent) {
    ...
    if (listener) {
      abstractEvent._dispatchListeners =
        accumulate_1(abstractEvent._dispatchListeners, listener);
  ...
  var mergeHelpers = {
    ...
    checkArrayStrategy: function(strategy) {
      throwIf_1(
        ...
        ERRORS$1.MERGE_DEEP_NO_ARR_STRATEGY
      );
    },
  ...
  var injection$1 = {
    ...
    _recomputePluginsList: function() {
      ...
      if (injection$1.EventPluginOrder) {  // Else, do when plugin order injected
  ...
  function recordAllRegistrationNames(eventType, PluginModule) {
    ...
    if (phasedRegistrationNames) {
      for (phaseName in phasedRegistrationNames) {
        ...
        if (__DEV__) {
          throwIf_1(
            registrationNames$2[phasedRegistrationNames[phaseName]],
            ERRORS.DOUBLE_REGISTER
          );
        }
      ...
      if (__DEV__) {
        throwIf_1(
          registrationNames$2[eventType.registrationName],
          ERRORS.DOUBLE_REGISTER
        );
      }
  ...
  function getPluginModuleForAbstractEvent(abstractEvent) {
    if (abstractEvent.type.registrationName) {
      ...
      for (var phase in abstractEvent.type.phasedRegistrationNames) {
        ...
        var PluginModule = registrationNames$2[
  ...
  var executeDispatchesAndRelease = function(abstractEvent) {
    if (abstractEvent) {
      ...
      EventPluginUtils_1.executeDispatchesInOrder(
        abstractEvent,
        pluginExecuteDispatch || EventPluginUtils_1.executeDispatch
      );
  ...
  function listenAtTopLevel(touchNotMouse) {
    ...
    trapBubbledEvent(
      topLevelTypes$2.topDOMCharacterDataModified,
  ...
  function handleTopLevel(
      ...
      renderedTargetID,
      renderedTarget) {
    var abstractEvents = EventPluginHub_1.extractAbstractEvents(
      topLevelType,
      nativeEvent,
      renderedTargetID,
      renderedTarget
  ...
  var ReactEventTopLevelCallback = {
    ...
    createTopLevelCallback: function(topLevelType) {
      return function(fixedNativeEvent) {
        ...
        var renderedTarget = ReactInstanceHandles_1.getFirstReactDOM(
          fixedNativeEvent.target
        ) || ExecutionEnvironment_1.global;
  ...
  var ReactMount = {
    ...
    registerContainer: function(container) {
      ...
      if (!reactRootID) {
        ...
        reactRootID = ReactInstanceHandles_1.getReactRootID(
    ...
    getCachedNodeByID: function(id) {
      return nodeCache[id] ||
        (nodeCache[id] =
          ...
          ReactMount_1.findReactRenderedDOMNodeSlow(id));
    }
  };
  ...
  var ReactCompositeComponentMixin = {
    ...
    updateComponent: function(transaction) {
      ...
      if (currentComponent.constructor === nextComponent.constructor) {
        ...
        ReactComponent_1.DOMIDOperations.dangerouslyReplaceNodeWithMarkupByID(
          currentComponentID,
          nextMarkup
        );
    ...
    _renderValidatedComponent: function() {
      ...
      invariant_1(
        ReactComponent_1.isValidComponent(renderedComponent),
  ...
  var ReactMultiChildMixin = {
    ...
    processChildDOMOperationsQueue: function() {
      if (this.domOperations) {
        ReactComponent_1.DOMIDOperations
  ...
  mixInto_1(ReactTextComponent, {
    ...
    mountComponent: function(rootID) {
      ...
      return (
        '<span id="' + rootID + '">' +
          escapeTextForBrowser_1(this.props.text) +
        '</span>'
      );
    },
    ...
    receiveProps: function(nextProps, transaction) {
      if (nextProps.text !== this.props.text) {
        ...
        ReactComponent_1.DOMIDOperations.updateTextContentByID(
          this._rootNodeID,
          nextProps.text
        );
      }
          ...
          for (var key in children) {
            if (children.hasOwnProperty(key)) {
              flattenChildrenImpl(
                res,
                children[key],
                nameSoFar + '{' + escapeTextForBrowser_1(key) + '}'
              );
            }
          }
        } else if (type === 'string') {
  ...
  var CONTENT = keyOf_1({content: null});
  var DANGEROUSLY_SET_INNER_HTML = keyOf_1({dangerouslySetInnerHTML: null});
      ...
      if (innerHTML != null) {
        ...
        if (contentToUse != null) {
          ...
          return this.mountMultiChild(
            flattenChildren_1(childrenToUse),
            transaction
          );
        }
      }
    ...
    _updateDOMProperties: function(nextProps) {
      ...
      for (var propKey in nextProps) {
        ...
        if (propKey === STYLE) {
          ...
          if (styleUpdates) {
            ReactComponent_1.DOMIDOperations.updateStylesByID(
              this._rootNodeID,
              styleUpdates
            );
          }
          ...
          if (lastHtml !== nextHtml) {
            ReactComponent_1.DOMIDOperations.updateInnerHTMLByID(
              this._rootNodeID,
              nextProp
            );
          }
          ...
          ReactComponent_1.DOMIDOperations.updatePropertyByID(
            this._rootNodeID,
            propKey,
            nextProp
          );
  ...
  var ReactDOMForm = ReactCompositeComponent_1.createClass({
    ...
    componentDidMount: function(node) {
      ReactEvent_1.trapBubbledEvent(
        EventConstants_1.topLevelTypes.topSubmit,
        'submit',
        node
      );
    }
  ...
  var abstractEventTypes = {
    mouseEnter: {registrationName: keyOf_1({onMouseEnter: null})},
    mouseLeave: {registrationName: keyOf_1({onMouseLeave: null})}
  };
  ...
  var extractAbstractEvents = function(
    ...
    if (topLevelType === topLevelTypes$1.topMouseOver &&
        (nativeEvent.relatedTarget || nativeEvent.fromElement)) {
      return;
    }
    if (topLevelType !== topLevelTypes$1.topMouseOut &&
       topLevelType !== topLevelTypes$1.topMouseOver){
    ...
    var leave = AbstractEvent_1.getPooled(
      abstractEventTypes.mouseLeave,
      fromID,
      topLevelType,
      nativeEvent
    );
    var enter = AbstractEvent_1.getPooled(
  ...
  var SimpleEventPlugin = {
    abstractEventTypes: {
      ...
      mouseWheel: {
        phasedRegistrationNames: {
          bubbled: keyOf_1({onMouseWheel: true}),
          captured: keyOf_1({onMouseWheelCapture: true})
        }
      },
      touchStart: {
        phasedRegistrationNames: {
      ...
      change: {
        phasedRegistrationNames: {
          bubbled: keyOf_1({onChange: true}),
          captured: keyOf_1({onChangeCapture: true})
        }
      },
      submit: {
        phasedRegistrationNames: {
      ...
      DOMCharacterDataModified: {
        phasedRegistrationNames: {
          bubbled: keyOf_1({onDOMCharacterDataModified: true}),
          captured: keyOf_1({onDOMCharacterDataModifiedCapture: true})
        }
      }
    },
    ...
    extractAbstractEvents:
      function(topLevelType, nativeEvent, renderedTargetID, renderedTarget) {
        ...
        var abstractEvent = AbstractEvent_1.getPooled(
          abstractEventType,
          renderedTargetID,
          topLevelType,
          nativeEvent,
